        ...
        <div className="prose prose-lg max-w-none">
          <div className="mb-8">
            ...
            <p className="text-gray-700">
              ...
              rights in all aspects of our business operations. We believe that
              access to travel, accommodation, and transportation services
              should be available to all people regardless of their race,
              ethnicity, gender, sexual orientation, religion, disability, age,
              or nationality. This Human Rights Statement outlines our
              commitment to upholding fundamental human rights principles.
            </p>
          </div>
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-700 mb-4">
              We are committed to providing equal access to our services without
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-700 mb-4">
              We are committed to fair labor practices and respect for workers'
              rights:
            </p>
            <ul className="list-disc pl-6 text-gray-700 space-y-2">
              <li>
                We prohibit forced labor, child labor, and human trafficking in
              ...
              <li>
                We provide equal opportunities for professional development and
                advancement
              </li>
            </ul>
          </div>
          ...
          <div className="mb-8">
            ...
            <ul className="list-disc pl-6 text-gray-700 space-y-2">
              ...
              <li>We provide safety resources and guidelines for travelers</li>
            </ul>
          </div>
          ...
          <div className="mb-8">
            ...
            <ul className="list-disc pl-6 text-gray-700 space-y-2">
              ...
              <li>We provide information about sustainable travel practices</li>
              <li>
                We work to minimize our environmental impact through
                digital-first operations
              </li>
              <li>
                We support local communities and responsible tourism initiatives
              </li>
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-700 mb-4">
              We provide multiple channels for reporting human rights concerns:
            </p>
            <ul className="list-disc pl-6 text-gray-700 space-y-2">
