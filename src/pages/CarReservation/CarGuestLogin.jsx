...
import { useCarLoginWebsiteMutation } from "../../redux/api/car/carApi";
// import { useGuestLoginMutation } from "../../redux/api/hotel/hotelApi";
// import { useGuestLoginMutation } from "../../redux/api/car/carApi";

export default function CarGuestLogin() {
  ...
  const [carLoginWebsite] = useCarLoginWebsiteMutation();
  ...
  const handleGuestLoginThenProceed = async (e) => {
    ...
    try {
      ...
      const res = await carLoginWebsite(payload).unwrap();
